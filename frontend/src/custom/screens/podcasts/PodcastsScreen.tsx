...
/**
 * Downstream Podcasts screen. Owns page composition (header, setup alert,
 * tab navigation) while reusing upstream podcast infrastructure: episode and
 * profile hooks with polling, EpisodesTab (generation flow, status groups,
 * audio playback, retry/delete), TemplatesTab (profile panels with CRUD and
 * test flows), and UI primitives — no second backend, state machine, or
 * audio mechanism.
 */
