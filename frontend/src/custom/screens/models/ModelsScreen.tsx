...
/**
 * Downstream Models screen. Owns page composition (header, alerts,
 * selectors placement, provider grid, help link) while reusing upstream
 * model-management infrastructure: credentials/models/providers hooks,
 * ProviderSection with its credential dialogs and test flows,
 * DefaultModelSelectors, MigrationBanner, and UI primitives.
 */
export function ModelsScreen() {
  ...
  if (isLoading) {
    return (
      <AppShell>
        <div className="flex items-center justify-center min-h-[60vh] bg-[var(--custom-page)]">
    ...
    <AppShell>
      <div className="flex-1 overflow-y-auto bg-[var(--custom-page)] text-[var(--custom-foreground)]">
        <div className="p-6 space-y-6">
          ...
          {/* Help link */}
          <div className="border-t border-[var(--custom-border)] pt-4">
            <a
