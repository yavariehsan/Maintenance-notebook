...
import { NotebookList } from '@/app/(dashboard)/notebooks/components/NotebookList'
import { RecentlyViewed } from '@/app/(dashboard)/notebooks/components/RecentlyViewed'
import { Button } from '@/components/ui/button'
import { EmptyState } from '@/components/common/EmptyState'
import { CircleAlert, Plus, RefreshCw, LayoutGrid, List } from 'lucide-react'
...
/**
 * First downstream screen. Owns the notebooks composition (filtering,
 * view mode, dialogs) while reusing upstream data hooks, list components,
 * and dialogs — no new API clients or state logic.
 */
export function NotebookListScreen() {
  ...
  if (isError) {
    return (
      <AppShell>
        <div className="flex-1 overflow-y-auto bg-[var(--custom-page)]">
          <div className="p-6">
            <EmptyState
              icon={CircleAlert}
      ...
      <div className="flex-1 overflow-y-auto bg-[var(--custom-page)] text-[var(--custom-foreground)]">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
            <div className="flex items-center rounded-md border border-[var(--custom-border)] bg-[var(--custom-surface)] p-0.5">
              <Button
