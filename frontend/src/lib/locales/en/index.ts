export const en = {
  common: {
    ...
    newNotebook: "New Knowledge Base",
    ...
    notebookLabel: "Knowledge Base: {{name}}",
    ...
    accessibility: {
      ...
      searchNotebooks: "Search knowledge bases",
    },
    url: "URL",
  ...
  apiErrors: {
    notebookNotFound: "Knowledge base not found",
  ...
  connectionErrors: {
    ...
    apiDesc: "The Maintenance AI Agent API server could not be reached",
    ...
    docLink: "Maintenance AI Agent Documentation",
  ...
  navigation: {
    ...
    smartMaintenanceGuide: "Smart Maintenance Guide",
    podcasts: "Podcasts",
    tasks: "Tasks",
    models: "Models",
  ...
  notebooks: {
    ...
    archive: "Archive",
    unarchive: "Unarchive",
    deleteNotebook: "Delete Knowledge Base",
    ...
    deleteNotebookExclusiveSources: "{{count}} source(s) exist only in this knowledge base.",
    deleteNotebookSharedSources: "{{count}} source(s) are shared with other knowledge bases and will be unlinked.",
    deleteNotebookNoSources: "No sources in this knowledge base.",
    deleteExclusiveSourcesLabel: "Delete exclusive sources",
    keepExclusiveSourcesLabel: "Unlink and keep them",
    activeNotebooks: "Active Knowledge Bases",
    archivedNotebooks: "Archived Knowledge Bases",
    tileView: "Tile view",
    listView: "List view",
    notFound: "Knowledge base not found",
    notFoundDesc: "The requested knowledge base does not exist.",
    updated: "Updated",
    ...
    descPlaceholder: "Add more info about this knowledge base here...",
    ...
    recentlyViewedNotebook: "Knowledge Base",
    recentlyViewedSource: "Source",
    lastViewed: "Viewed {{time}}",
  },
  assets: {
    title: "Assets",
    description: "Equipment and machine registry for maintenance operations.",
    newAsset: "New Asset",
    editAsset: "Edit Asset",
    emptyTitle: "No assets yet",
    emptyDescription: "Register your first asset to start building the maintenance registry.",
    ...
    subClass: "Sub Class",
    toggleDetails: "Show equipment details",
    importButton: "Import Excel",
    importTitle: "Import Equipment from Excel",
    importDescription: "Upload an .xlsx file with equipment records. The file is validated first; confirm the preview to import.",
    importFile: "Excel file",
    importValidating: "Validating file...",
    importPreviewTitle: "{{valid}} of {{total}} rows valid",
    importPreviewHint: "Review the rows below, then confirm to import the valid rows. Duplicate codes are rejected, never overwritten.",
    importConfirm: "Import valid rows",
    importSuccess: "{{count}} equipment records imported",
    importSkipped: "{{count}} rows were skipped (see details).",
    importMoreRows: "{{count}} more rows",
  },
  maintenance: {
    title: "Smart Maintenance Guide",
    description: "Ask questions about an equipment's maintenance history, answered from its CMMS reports.",
    selectEquipmentTitle: "Step 1 — Select equipment",
    equipmentLabel: "Equipment",
    equipmentPlaceholder: "Select an equipment code...",
    selectedEquipment: "Selected: {{equipment}}",
    sourcesLoading: "Loading CMMS reports...",
    sourcesCount: "{{count}} CMMS reports associated with {{code}}",
    sourcesLoadFailed: "Failed to load CMMS reports. Retry.",
    askTitle: "Step 2 — Ask a maintenance question",
    questionLabel: "Question",
    questionPlaceholder: "e.g. What were the most common failures of this equipment?",
    askButton: "Ask",
    answering: "Searching maintenance records and generating the answer...",
    askFailed: "Failed to generate the answer.",
    noEquipmentTitle: "No equipment registered",
    noEquipmentDescription: "Register equipment in the Assets section (manually or via Excel import) before using the Smart Maintenance Guide.",
    equipmentLoadFailed: "Failed to load equipment",
    noSourcesTitle: "No maintenance records for this equipment",
    noSourcesDescription: "No CMMS reports are associated with equipment code {{code}} yet. Associate a report with this code from the Sources section.",
    noContextTitle: "No relevant maintenance information",
    noContextDescription: "The CMMS reports for equipment code {{code}} do not contain information relevant to this question.",
    sourcesTitle: "Supporting CMMS reports",
  },
  sources: {
    title: "Sources",
    newSource: "New Source",
    ...
    sourcesAddedToNotebook: "{{count}} source(s) added to knowledge base",
    failedToAddSourcesToNotebook: "Failed to add sources to knowledge base",
    partialAddSuccess: "{{success}} source(s) added, {{failed}} failed",
    sourceRemovedFromNotebook: "Source removed from knowledge base successfully",
    failedToRemoveSourceFromNotebook: "Failed to remove source from knowledge base",
    removeConfirm: "Are you sure you want to remove this from the knowledge base?",
    checking: "Checking...",
    ...
    batchCommonSettings: "The same knowledge bases and transformations will be applied to all items.",
    ...
    manageNotebooks: "Manage Knowledge Bases",
    manageNotebooksDesc: "Manage which knowledge bases contain this source",
    noNotebooksAvailable: "No knowledge bases available",
    removeFromNotebook: "Remove from Knowledge Base",
    retryProcessing: "Retry Processing",
    refreshContent: "Refresh content",
    deleteSource: "Delete Source",
    retry: "Retry",
    addExistingTitle: "Add Existing Sources",
    addExistingDesc: "Select existing sources from across all your knowledge bases to add to the current one.",
    searchPlaceholder: "Search sources by name or URL...",
    noNotebooksFound: "No knowledge bases found.",
  ...
  chat: {
    ...
    chatWithNotebook: "Chat with Knowledge Base",
    unableToLoadChat: "Unable to load chat",
    noDescription: "No description",
    startByCreating: "Start by creating your first knowledge base to organize your research.",
  ...
  searchPage: {
    ...
    ask: "Ask",
    processing: "Processing...",
    saveToNotebooks: "Save to Knowledge Bases",
    ...
    scopeNotebooks: "Knowledge Bases",
    scopeAllNotebooks: "All knowledge bases",
    scopeNotebooksSelected: "{{count}} selected",
    scopeClear: "Clear",
    scopeHint: "Leave all unchecked to search your whole knowledge base.",
    scopeNoNotebooks: "No knowledge bases yet.",
    resultsFound: "{{count}} results found",
    matches: "Matches ({{count}})",
    noResultsFor: "No results found for “{{query}}”",
    notSet: "Not set",
    saveToNotebook: "Save to Knowledge Base",
    saveSuccess: "Successfully saved to knowledge base",
    saveError: "Failed to save to knowledge base",
    selectNotebook: "Select Knowledge Base",
  ...
  podcasts: {
    ...
    content: "Content",
    contentDesc: "Pick knowledge bases, sources, and notes to include in this episode.",
    itemsSelected: "{{count}} items selected",
    tokens: "{{value}} tokens",
    chars: "{{value}} chars",
    loadingNotebooks: "Loading knowledge bases...",
    noNotebooksFoundInPodcasts: "No knowledge bases found. Create a knowledge base and add content before generating a podcast.",
    ...
    sources: "Sources",
    notes: "Notes",
    noSources: "No sources available in this knowledge base.",
    noNotes: "No notes available in this knowledge base.",
    ...
    noEpisodesYet: "No podcast episodes yet. Generate your first one from the knowledge base or source chat interfaces.",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Maintenance AI Agent to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Maintenance AI Agent is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  tasks: {
    title: "Tasks",
    description: "Background embedding jobs and their real progress.",
    emptyTitle: "No embedding jobs yet",
    emptyDescription: "Click “Embed Content” on a source and the job will show up here with live progress.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Maintenance AI Agent",
    missingRequiredModels: "Missing required models: {{models}}. Maintenance AI Agent may not function properly without these.",
